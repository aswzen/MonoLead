...
(function(e) {
    e.fn.jqte = function(t) {
        ...
        return this.each(function() {
            ...
            h.html('<div class="' + u.css + "_toolbar" + '" role="toolbar" unselectable></div><div class="' + u.css + '_linkform" style="display:none" role="dialog"></div><div class="' + u.css + "_editor" + '" style="width:' + u.mywidth + '; height:' + u.myheight + ';"></div>');
            ...
            var S = u.css + "-setlink";
            v.after('<div class="' + u.css + "_source " + u.css + '_hiddenField" style="width:' + u.mywidth + '; height:' + u.myheight + ';"></div>');
